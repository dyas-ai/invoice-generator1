...
def generate_proforma_invoice(df, form_data):
    ...
    consignee_data = [
        ...
        [Paragraph(f"{form_data['consignee_name']}<br/>{form_data['consignee_address']}<br/>{form_data['consignee_tel']}", 
         ...
         Paragraph(f"<br/><br/><b>Bank Details</b><br/><b>Beneficiary</b> :- {form_data['bank_beneficiary']}<br/><b>Account No</b> :- {form_data['bank_account']}<br/><b>BANK'S NAME</b> :- {form_data['bank_name']}<br/><b>BANK ADDRESS</b> :- {form_data['bank_address']}<br/><b>SWIFT CODE</b> :- {form_data['bank_swift']}<br/><b>BANK CODE</b> :- {form_data['bank_code']}", 
                   bank_style)]
    ]
